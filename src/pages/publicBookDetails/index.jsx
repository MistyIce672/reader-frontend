...
const PublicBookDetails = () => {
  ...
  useEffect(() => {
    const fetchBookDetails = async () => {
      try {
        const bookData = await publicBookService.getPublicBookDetails(bookId);
        setBook(bookData.data);
        setLoading(false);
      } catch (err) {
        setError("Failed to load public book details");
        setLoading(false);
      }
    };
  ...
  const handleReadClick = () => {
    navigate(`/public-books/${bookId}/read/1`);
  };
              ...
              <div className="grid grid-cols-1 gap-6">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-green-700 font-medium">
                    5x cheaper than personal books
                  </span>
                </div>
      ...
      <section className="bg-indigo-700 mt-12">
        <div className="max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 text-lg text-indigo-200">
            This public book costs 5x less points per page.
          </p>
          <button
